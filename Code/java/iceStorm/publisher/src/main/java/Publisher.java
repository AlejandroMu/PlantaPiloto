...
public class Publisher
{
    ...
    private static int run(com.zeroc.Ice.Communicator communicator, String[] args)
    {
        ...
        MeasuresPrx measures = MeasuresPrx.uncheckedCast(publisher);

        System.out.println("publishing measuresments events. Press ^C to terminate the application.");
        try
        {
            ...
            while(true)
            {
                ...
                measures.putMeasure(random.nextDouble());
